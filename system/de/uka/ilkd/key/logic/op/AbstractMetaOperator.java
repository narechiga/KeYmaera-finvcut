...
import de.uka.ilkd.key.dl.rules.metaconstruct.*;
...
public abstract class AbstractMetaOperator extends Op implements MetaOperator {
	...
	public static final BarrierDiffInd BARRIERDIFFIND = new BarrierDiffInd();
	public static final AbstractMetaOperator DIFFFIN = new DiffFin();
    public static final DRI DRI = new de.uka.ilkd.key.dl.rules.metaconstruct.DRI();
